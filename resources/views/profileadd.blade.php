...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
        <div class="caption"><i class="fa fa-reorder"></i><?php echo trans('surveys.profile'); ?></div>
    </div>
    <div class="portlet-body form">

        <form action="<?php echo url('/profileadd');?>" method="POST" enctype="multipart/form-data" class="form-horizontal" role="form" >
            {{ csrf_field() }}
            <div class="form-body">
